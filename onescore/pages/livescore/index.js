    ...
    <div className='livescore'>
      {livescores.map((livescore) => (
        <div key={livescore.index} className='livescorecard'>
          <img className='country-flag' src={livescore.area.flag}  alt='country flag' />
          <p className='country' >{livescore.area.name}</p>
          <img className='league-logo' src={livescore.competition.emblem}  alt='league-logo' />
          <p className='league'>{livescore.competition.name}</p>
          <p className='current-matchday'>Matchday: {livescore.season.currentMatchday}</p>
          <img clasName='home-team-img' src={livescore.homeTeam.crest} alt='home team' />
          <p className='home-team'>{livescore.homeTeam.name}</p>
          <img clasName='away-team-img' src={livescore.awayTeam.crest} alt='away team' />
          <p className='away-team'>{livescore.awayTeam.name}</p>
          <div className='score'>
            <p className='score-home-ht'>HT {livescore.score.halfTime.home} :</p>
            <p className='score-away-ht'>{livescore.score.halfTime.away}</p>
            <p className='score-home-ft'>FT {livescore.score.fullTime.home} :</p>
